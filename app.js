...
/*
  ...
  Fazemos assim para evitar que
  o navegador mude o dia por
...
async function renderHeader(date) {
  ...
  /*
    ...
    com o dia que está sendo exibido.
  */
...
/*
  NOVO:
  quando uma data é escolhida
  no calendário.
*/

if (els.datePicker) {

  els.datePicker.addEventListener(
    "change",
    chooseDate
  );
